...
object NoteData {
    ...
    private val lifeIsBeautiful = Note(
        "La vie est belle",
    ...
    private val neverLetAnyoneTell = Note(
    ...
    private val followYourDreams = Note(
        "Suivez vos rêves",
    ...
    private val beKindToOthers = Note(
    ...
    private val helpOthersAlways = Note(
        "Aidez les autres",
    ...
    private val beGratefulForWhat = Note(
    ...
    private val liveThePresentMoment = Note(
    ...
    private val takeCareOfYourself = Note(
        "Prenez soin de vous",
    ...
    private val spendTimeWithLoved = Note(
    ...
    private val laughAndHaveFun = Note(
        "Riez et amusez-vous.",
